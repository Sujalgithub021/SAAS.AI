...
const GenerateImages = () => {
  ...
  try {
    ...
    const {data} = await axios.post('/api/ai/generate-image', 
      { prompt: `${input} in ${selectedStyle}`, publish }, 
              ...
              <div className='mt-3 h-full'>
                ...
                {imageLoading && (
                  <div className='absolute inset-0 flex items-center justify-center bg-gray-50 rounded-lg'>
                    <span className='w-8 h-8 rounded-full border-2 border-green-500 border-t-transparent animate-spin'></span>
                  </div>
                )}
                  <img 
                  src={content} 
                  ...
                  onError={(e) => { 
                    ...
                    toast.error("Image load failed, retry") 
                  }}
